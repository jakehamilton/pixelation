...
export class MouseInput {
	...
	y = 0;
	/**
	 * Whether the mouse is over the game element. This is useful for
	 * only drawing the mouse when it should be visible.
	 */
	visible = false;

	/**
	 * Whether the primary (left) click is active.
	 */
	primary = false;
	/**
	 * Whether the secondary (right) click is active.
	 */
	secondary = false;
	/**
	 * Whether the tertiary (middle) click is active.
	 */
	middle = false;
...
export class KeyboardInput {
	/**
	 * A keymap, storing whether each key has been held or pressed. A
	 * held key means that it is currently held down. A pressed key means
	 * that the key is done being held down and has returned to its normal state.
	 */
	keys = {
	...
	/**
	 * Determine whether a key is currently being held down.
	 */
	...
	/**
	 * Determine whether a key has just been pressed.
	 */
...
export class GamepadInput {
	...
	/**
	 * The raw web Gamepad API object.
	 */
	device: Gamepad | null = null;

	/**
	 * The buttons that the gamepad has, each storing whether they
	 * are held or pressed.
	 */
	buttons: Array<{
		held: boolean;
